...
export default function NotFoundScreen() {
  ...
  return (
    <section className="mx-auto flex min-h-[calc(100vh-8rem)] w-full items-center px-4 py-16 sm:px-6 lg:px-8">
      <div className="relative w-full overflow-hidden rounded-4xl border border-primary/10 px-6 py-14 shadow-[0_20px_60px_rgba(117,13,18,0.05)] sm:px-10">
